...
const Automotive = () => {
  return (
    <>
      <Navbar />
      <div className="flex flex-col min-h-screen bg-gray-50 text-gray-900 px-6 sm:px-8 lg:px-16 py-12 space-y-12 lg:mx-12 mt-12">
        {/* Hero Section */}
        <section className="space-y-6">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold">
            Unsere Automotive Testing Dienstleistungen
          </h1>
          <h3 className="text-2xl sm:text-xl lg:text-3xl font-bold">
            Schwerpunkte
          </h3>
          <ul className="list-disc list-inside space-y-2 text-gray-800 leading-relaxed">
            <li>
              <strong>Fahrzeug- und Komponentenprüfung:</strong> Umfassende
              Tests von elektronischen Steuergeräten, Sensoren, Aktoren und
            ...
            <li>
              ...
              frühzeitigen Fehlererkennung und Optimierung von
              Fahrzeugfunktionen.
            </li>
            <li>
              <strong>Datenanalyse & Reporting:</strong> Detaillierte Auswertung
              und Visualisierung von Testergebnissen, um fundierte
              Entscheidungen für Entwicklung und Serienproduktion zu
              unterstützen.
            </li>
          </ul>
          <Link to="/contact">
        ...
        <section className="space-y-8">
          ...
          <div className="bg-white rounded-2xl ">
            <p className="text-gray-800 leading-relaxed">
              Jede Testkomponente ist gezielt ausgewählt, um Qualität,
              Sicherheit und Nachvollziehbarkeit in automobilen
              Entwicklungsprojekten sicherzustellen – von der frühen
              Softwarevalidierung bis zur Serienfreigabe. Entwickelt von Mira
