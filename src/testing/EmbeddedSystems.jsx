    ...
    <div className="flex flex-col min-h-screen bg-gray-50 text-gray-900 px-6 sm:px-8 lg:px-16 py-12 space-y-16 lg:mx-12">
      ...
      <section className="space-y-6 max-w-6xl">
        ...
        <p className="text-gray-800 leading-relaxed">
          ...
          mikrocontroller-naher Firmware über Echtzeitbetriebssysteme bis hin zu
          kompletten Steuergeräten. Dabei kombinieren wir strukturierte
          Testmethoden mit automatisierten Prüfprozessen für reproduzierbare und
        ...
        <p className="text-gray-800 leading-relaxed">
          ...
          Speicherverwaltung und Fehlermanagement – unter realistischen und auch
          extremen Betriebsbedingungen.
        </p>

        <p className="text-gray-800 leading-relaxed">
          Mira Elektronikentwicklung verbindet tiefgehendes Embedded-Know-how
          mit normkonformen Testprozessen, um Risiken frühzeitig zu erkennen und
          Entwicklungszyklen nachhaltig zu verkürzen. Wir bieten
