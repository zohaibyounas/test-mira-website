    ...
    <div className="flex flex-col min-h-screen bg-gray-50 text-gray-900 px-6 sm:px-8 lg:px-16 py-12 space-y-16 lg:mx-12">
      ...
      <section className="space-y-6 max-w-6xl">
        ...
        <p className="text-gray-800 leading-relaxed">
          ...
          Zellüberwachungs- und Messfunktionen über Lade-/ Entladestrategien bis
          hin zu Diagnose-, Kommunikations- und Sicherheitsmechanismen. Dabei
          berücksichtigen wir reale Betriebsbedingungen sowie kritische Fehler-
          und Grenzfälle.
        </p>
        ...
        <p className="text-gray-800 leading-relaxed">
          ...
          Qualität, funktionale Sicherheit und Zuverlässigkeit über den gesamten
          Entwicklungszyklus hinweg zu gewährleisten.
        </p>
      ...
      <section className="space-y-8">
        ...
        <div className="bg-white rounded-2xl  max-w-6xl">
          <p className="text-gray-800 leading-relaxed">
            ...
            Zuverlässigkeit und Normkonformität von Battery Management Systemen
            sicherzustellen – von der Zellmessung bis zur
