...
const CyberSecurity = () => {
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 text-gray-900 px-6 sm:px-8 lg:px-16 py-12 space-y-16 lg:mx-12">
      {/* Intro Section */}
      <section className="space-y-6 max-w-6xl">
        ...
        <ul className="list-disc list-inside space-y-3 text-gray-800 leading-relaxed">
          <li>
            ...
            Anwendungen, Steuergeräte und Kommunikationsschnittstellen. Ziel ist
            es, reale Angriffsvektoren aufzudecken und Sicherheitslücken
          ...
          <li>
            ...
            Systemhärtung – unter Berücksichtigung aktueller Bedrohungsszenarien
            und Industriestandards.
          </li>
          <li>
            Mira Elektronikentwicklung kombiniert tiefgehendes Systemverständnis
            mit erprobten Cyber-Security-Strategien, um robuste,
            widerstandsfähige und zukunftssichere Systeme zu realisieren.
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-8">
        ...
        <div className="bg-white rounded-2xl  max-w-6xl">
          <p className="text-gray-800 leading-relaxed">
            ...
            systematisch aufzudecken, reale Angriffsszenarien zu simulieren und
            die Sicherheit von IT-, OT- und Embedded-Systemen nachhaltig zu
            erhöhen – von der Analyse bis zur Absicherung. Entwickelt von Mira
        ...
        <div className="max-w-4xl">
          <p className="text-gray-800 leading-relaxed">
            ...
            kritischer Infrastrukturen, Embedded-Systeme und vernetzter Produkte
            unterstützen.
          </p>
        </div>
      </section>
